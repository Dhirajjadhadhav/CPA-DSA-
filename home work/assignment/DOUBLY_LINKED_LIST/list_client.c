...
int main(void)
{
    ...
    printf("after the remove end\n");
    assert(status);
    show(p_list, "Aftetr remove_end:");
    ...
    show(p_cat_list, "Immutable concatenation of list 1 & 2");
